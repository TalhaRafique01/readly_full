    ...
    <div className="flex min-h-screen bg-blue-100">
      ...
      <div className="w-16 sm:w-64 bg-blue-600 text-white shadow-lg flex flex-col items-center py-8">
        ...
        <div className="flex flex-col space-y-4 w-full">
          <Link
            to="/Contact"
            className={`flex items-center space-x-2 w-full py-3 px-4 text-left ${activeTab === 'Contact' ? 'bg-blue-700' : ''}`}
          ...
          <Link
            to="/setting"
            className={`flex items-center space-x-2 w-full py-3 px-4 text-left ${activeTab === 'home' ? 'bg-blue-700' : ''}`}
